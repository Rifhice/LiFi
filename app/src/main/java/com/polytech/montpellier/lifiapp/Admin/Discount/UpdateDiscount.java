...
public class UpdateDiscount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AbstractDAOFactory.getFactory(AbstractDAOFactory.DISTANT_DAO_FACTORY).getDiscountDAO().getById(id, new ResponseHandler() {
            @Override
        ...
        if(endDate.getTimeInMillis()>startDate.getTimeInMillis()){
            ...
            if (isPercentage) {
                if(!percentage.getText().toString().isEmpty()){
                    ...
                    AbstractDAOFactory.getFactory(AbstractDAOFactory.DISTANT_DAO_FACTORY).getDiscountDAO().update(discount, UserConnection.getInstance().getToken(), new ResponseHandler() {
                        @Override
                        public void onSuccess(Object object) {
                            finish();
                        }
